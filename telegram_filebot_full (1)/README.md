...
```
این دستور کانتینر بک‌اند FastAPI و یک کانتینر Nginx را اجرا می‌کند.
Nginx به عنوان پروکسی معکوس عمل کرده و فایل‌های موجود در
دایرکتوری `uploads` را مستقیماً سرو می‌کند تا دانلودها سریع‌تر انجام شود.
